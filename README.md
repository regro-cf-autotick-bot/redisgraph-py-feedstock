...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/redisgraph-py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12369&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/redisgraph-py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `redisgraph-py` can be installed with:

```
conda install redisgraph-py
```

It is possible to list all of the versions of `redisgraph-py` available on your platform with:
